...
app = FastAPI(
    title="Smart Agro Clima - Inteligência Climática para o Agro",
...
@app.get("/")
def read_root():
    return {"message": "Bem-vindo à API Smart Agro Clima"}
...
async def send_feedback(feedback: Feedback):
    ...
    subject = f"Novo Feedback do App Smart Agro Clima: {feedback.name or 'Anônimo'}"
